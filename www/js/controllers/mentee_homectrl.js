  ...
  $scope.addgoal = function()
      {
        ...
        else 
        {
          ...
          console.log($scope.goalsObj.selectedImgName)
...
//function for adding comments for the mentee goals
    $scope.commentObj_goal={};
      ...
      $scope.addcomment=function(){
        ...
        if($scope.commentObj_goal.comment != "") {    
      $http({
  ...
  //sub function for add task with file function
    ...
    console.log($scope.edit_mentee_taskObj.selected_img)
      ...
      $scope.fun3=function(menteetask_id){
        ...
        due_date= moment($scope.edit_mentee_taskObj.task_date).format('YYYY-MM-DD');
        ...
        $http(
          {
            ...
            data:{editor_id:localStorage.getItem('id'),edited_by:localStorage.getItem('type'),
              ...
              shab:$scope.edit_mentee_taskObj.selected_img_base64,edited_date:currentDate,
              task_id:menteetask_id,due_date:due_date}
        })
        .then(function(response){
        console.log(response.data)
            $scope.gettasks();
